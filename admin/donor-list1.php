...
?>
			...
			<tr class="text-black">
				...
				<th><?php echo $res['FullName'] ?></th>
				<th><?php echo $res['MobileNumber'] ?></th>
				<th><?php echo $res['EmailId'] ?></th>
				<th><?php echo $res['Age'] ?></th>
				<th><?php echo $res['Gender'] ?></th>
				<th><?php echo $res['BloodGroup'] ?></th>
				<th><?php echo $res['Address'] ?></th>
				<th><?php echo $res['quantity_of_blood'] ?></th>
				<th><a  href="update-donor.php?id=<?php echo $res['id']; ?>" class="text-white"><button class="btn btn-success">View</button></a></th>
			</tr>
<?php }
?>
